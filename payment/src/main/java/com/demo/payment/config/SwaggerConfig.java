...
public class SwaggerConfig {
	public static final String SWAGGER_GROUP_NAME = "payment";
	public static final String SWAGGER_CONFIG_BASE_PACKAGE = "com.demo.payment.PaymentController";
	public static final String SWAGGER_CONFIG_TITLE = "Payment Service Api Documentation";
