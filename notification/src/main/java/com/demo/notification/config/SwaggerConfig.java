...
public class SwaggerConfig {
	public static final String SWAGGER_GROUP_NAME = "notification";
	public static final String SWAGGER_CONFIG_BASE_PACKAGE = "com.demo.notification.NotificationController";
	public static final String SWAGGER_CONFIG_TITLE = "Notification Service Api Documentation";
