...
public class SwaggerConfig {
	public static final String SWAGGER_GROUP_NAME = "order";
	public static final String SWAGGER_CONFIG_BASE_PACKAGE = "com.demo.order.OrderController";
	public static final String SWAGGER_CONFIG_TITLE = "Order Service Api Documentation";
